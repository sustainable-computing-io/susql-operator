...
oc exec -it curl-pod -n openshift-kepler-operator -- sh -c 'curl -k http://prometheus-susql.openshift-monitoring.svc.cluster.local:9090/metrics' 2>&1| tee susqlMetrics.txt
